...
-- Script date 2017-08-26 19:22:02
...
-- Table `1.1210`.nc_cms_article does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_article_class
--

-- Table `1.1210`.nc_cms_article_class does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_comment
--

-- Table `1.1210`.nc_cms_comment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_topic
--

-- Table `1.1210`.nc_cms_topic does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account
--

-- Table `1.1210`.ns_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_assistant_records
--

-- Table `1.1210`.ns_account_assistant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_order_records
--

-- Table `1.1210`.ns_account_order_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_period
--

-- Table `1.1210`.ns_account_period does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_records
--

-- Table `1.1210`.ns_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_return_records
--

-- Table `1.1210`.ns_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_records
--

-- Table `1.1210`.ns_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_user_records
--

-- Table `1.1210`.ns_account_withdraw_user_records does not contain any data (it is empty)
...
-- Table `1.1210`.ns_cart does not contain any data (it is empty)

-- 
-- Dumping data for table ns_click_fabulous
--

-- Table `1.1210`.ns_click_fabulous does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult
--

-- Table `1.1210`.ns_consult does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult_type
--

-- Table `1.1210`.ns_consult_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon
--

-- Table `1.1210`.ns_coupon does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_goods
--

-- Table `1.1210`.ns_coupon_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_type
--

-- Table `1.1210`.ns_coupon_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_company
--

-- Table `1.1210`.ns_express_company does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping
--

-- Table `1.1210`.ns_express_shipping does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping_items
--

-- Table `1.1210`.ns_express_shipping_items does not contain any data (it is empty)
...
-- Table `1.1210`.ns_goods_attribute_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_value
--

-- Table `1.1210`.ns_goods_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_brand
--

-- Table `1.1210`.ns_goods_brand does not contain any data (it is empty)
...
-- Table `1.1210`.ns_goods_sku_picture does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture_delete
--

-- Table `1.1210`.ns_goods_sku_picture_delete does not contain any data (it is empty)
...
-- Table `1.1210`.ns_member_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account_records
--

-- Table `1.1210`.ns_member_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_balance_withdraw
--

-- Table `1.1210`.ns_member_balance_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_bank_account
--

-- Table `1.1210`.ns_member_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_express_address
--

-- Table `1.1210`.ns_member_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_favorites
--

-- Table `1.1210`.ns_member_favorites does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_gift
--

-- Table `1.1210`.ns_member_gift does not contain any data (it is empty)
...
-- Table `1.1210`.ns_member_recharge does not contain any data (it is empty)

-- 
-- Dumping data for table ns_offpay_area
--

-- Table `1.1210`.ns_offpay_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order
--

-- Table `1.1210`.ns_order does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_action
--

-- Table `1.1210`.ns_order_action does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods
--

-- Table `1.1210`.ns_order_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_express
--

-- Table `1.1210`.ns_order_goods_express does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_promotion_details
--

-- Table `1.1210`.ns_order_goods_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_payment
--

-- Table `1.1210`.ns_order_payment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_pickup
--

-- Table `1.1210`.ns_order_pickup does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_promotion_details
--

-- Table `1.1210`.ns_order_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund
--

-- Table `1.1210`.ns_order_refund does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shipping_fee
--

-- Table `1.1210`.ns_order_shipping_fee does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shop_return
--

-- Table `1.1210`.ns_order_shop_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_pickup_point
--

-- Table `1.1210`.ns_pickup_point does not contain any data (it is empty)
...
(11122, 1054, '广告位-6', '#', 'upload/advertising/1499442714.png', 4, 0, '#ffffff');
...
(1052, '商城首页logo右侧小广告', '商城首页logo右侧小广告', 0, 2, 1, 90, 170, 0, 0, 0, 'public/static/images/adv_position/shouyelogo.png', '#FFFFFF', 1, 0, 1),
...
(1056, '商城限时折扣轮播广告位', '商城限时折扣轮播广告位', 0, 2, 1, 443, 1903, 0, 0, 0, 'public/static/images/adv_position/xianshizhekou.png', '#FFFFFF', 1, 0, 1),
...
(1075, '商城品牌专区轮播广告位', '商城品牌专区轮播广告位', 0, 0, 1, 443, 1210, 0, 0, 0, 'public/static/images/adv_position/pinpaizhuanqu.png', '#000000', 1, 0, 1),
(1076, '商城积分中心轮播广告位', '商城积分中心轮播广告位', 0, 2, 1, 320, 910, 0, 0, 0, 'public/static/images/adv_position/jifenzhongxin.jpg', '#000000', 1, 0, 1),
(1102, '商城积分中心中部广告位', '商城积分中心中部广告位', 0, 2, 1, 60, 1210, 0, 0, 0, 'public/static/images/adv_position/jifenzhongxinzhongbu.jpg', '#000000', 1, 0, 1),
(1103, '商城登录页面轮播广告位', '商城登录页面轮播广告位', 0, 0, 1, 0, 0, 0, 0, 0, '', '', 1, 0, 1),
(1105, '手机端首页轮播广告位', '手机端首页轮播广告位', 0, 1, 1, 175, 320, 0, 0, 0, 'public/static/images/adv_position/waplunbo.png', '', 2, 0, 1),
(1152, '手机端会员中心广告位', '手机端会员中心广告位', 0, 2, 1, 100, 750, 0, 0, 0, 'public/static/images/adv_position/waphuiyuanzhongxin.png', '', 2, 0, 1),
(1162, '手机端品牌专区广告位', '品牌专区广告', 0, 2, 1, 192, 720, 0, 0, 0, 'public/static/images/adv_position/wappinpaizhuanqu.png', '', 2, 0, 1),
(1163, '手机端限时折扣专区广告位', '限时折扣专区广告位', 0, 2, 1, 130, 720, 0, 0, 0, 'public/static/images/adv_position/wapxianshizhekou.png', '', 2, 0, 1),
(1164, '手机端首页商城热卖广告位', '手机端商城热卖', 0, 2, 1, 100, 100, 0, 0, 0, 'public/static/images/adv_position/wapshangchengremai.png', '#000000', 2, 0, 1),
(1165, '手机端积分中心广告位', '积分中心广告位', 0, 2, 1, 100, 100, 0, 0, 0, 'public/static/images/adv_position/wapjifenzhongxin.png', '#000000', 2, 0, 1);
...
-- Table `1.1210`.ns_platform_goods_recommend does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend_class
--

-- Table `1.1210`.ns_platform_goods_recommend_class does not contain any data (it is empty)
...
-- Table `1.1210`.ns_platform_link does not contain any data (it is empty)

-- 
-- Dumping data for table ns_point_config
--

-- Table `1.1210`.ns_point_config does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling
--

-- Table `1.1210`.ns_promotion_bundling does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling_goods
--

-- Table `1.1210`.ns_promotion_bundling_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount
--

-- Table `1.1210`.ns_promotion_discount does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount_goods
--

-- Table `1.1210`.ns_promotion_discount_goods does not contain any data (it is empty)
...
-- Table `1.1210`.ns_promotion_gift does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_goods
--

-- Table `1.1210`.ns_promotion_gift_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong
--

-- Table `1.1210`.ns_promotion_mansong does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_goods
--

-- Table `1.1210`.ns_promotion_mansong_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_rule
--

-- Table `1.1210`.ns_promotion_mansong_rule does not contain any data (it is empty)
...
-- Table `1.1210`.ns_shop does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_ad
--

-- Table `1.1210`.ns_shop_ad does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_coin_records
--

-- Table `1.1210`.ns_shop_coin_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_express_address
--

-- Table `1.1210`.ns_shop_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_group
--

-- Table `1.1210`.ns_shop_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_navigation
--

-- Table `1.1210`.ns_shop_navigation does not contain any data (it is empty)
...
-- Table `1.1210`.ns_shop_order_account_records does not contain any data (it is empty)
...
-- Table `1.1210`.ns_supplier does not contain any data (it is empty)

-- 
-- Dumping data for table sys_addons
--

-- Table `1.1210`.sys_addons does not contain any data (it is empty)
...
-- Table `1.1210`.sys_custom_template does not contain any data (it is empty)
...
-- Table `1.1210`.sys_instance_type does not contain any data (it is empty)

-- 
-- Dumping data for table sys_module
--
INSERT INTO sys_module VALUES
(120, '系统', 'admin', 'system', 'modulelist', 0, 1, 'system/modulelist', 1, 1, 999, '''''', '', '', 1, 1477454152, 1477794717),
(121, '模块列表', 'admin', 'system', 'modulelist', 120, 2, 'system/modulelist', 1, 1, 2, '''''', '', '', 1, 0, NULL),
(122, '添加模块', 'admin', 'system', 'addmodule', 121, 3, 'system/addmodule', 0, 1, 1, '添加模块', '', '', 1, 0, 1479976597),
(123, '修改模块', 'admin', 'system', 'editmodule', 121, 3, 'system/editmodule', 0, 1, 2, '修改模块', '', '', 1, 0, 1479976646),
...
(191, '添加物流公司', 'admin', 'express', 'addexpresscompany', 189, 3, 'express/addexpresscompany', 1, 0, 1, '添加物流公司', '', '', 1, 1481267828, NULL),
(192, '物流公司修改', 'admin', 'express', 'updateexpresscompany', 189, 3, 'express/updateexpresscompany', 1, 0, 2, '物流公司修改排序', '', '', 1, 1481271808, NULL),
...
(394, '添加楼层', 'admin', 'system', 'addblock', 392, 3, 'system/addblock', 0, 0, 0, '', '', '', 1, 1490948318, NULL),
(395, '楼层编辑', 'admin', 'system', 'updateblock', 392, 3, 'system/updateblock', 0, 0, 0, '', '', '', 1, 1490948388, 1490952538),
...
(428, '添加导航', 'admin', 'config', 'addshopnavigation', 427, 3, 'config/addshopnavigation', 1, 0, 2, '添加导航', '', '', 0, 1492761909, NULL),
(429, '修改导航', 'admin', 'config', 'updateshopnavigation', 427, 3, 'config/updateshopnavigation', 1, 0, 3, '修改导航', '', '', 0, 1492762515, NULL),
...
(442, '添加帮助类型', 'admin', 'config', 'addhelpclass', 440, 3, 'config/addhelpclass', 0, 0, 1, '添加帮助类型', '', '', 1, 1493201673, NULL),
(443, '修改帮助内容', 'admin', 'config', 'updatedocument', 441, 3, 'config/updatedocument', 0, 0, 2, 'updateDocument.html', '', '', 1, 1493203409, NULL),
(444, '添加帮助内容', 'admin', 'config', 'adddocument', 441, 3, 'config/adddocument', 0, 0, 2, 'aaddDocument', '', '', 1, 1493205866, NULL),
...
(452, '添加文章', 'admin', 'cms', 'addarticle', 432, 3, 'cms/addarticle', 0, 0, 4, '', '', '', 1, 1493287571, 1493289825),
(454, '销售统计', 'admin', 'account', 'orderaccountcount', 409, 2, 'account/orderaccountcount', 0, 0, 6, '', '', '', 1, 1493289961, 1493981704),
(455, '修改文章', 'admin', 'cms', 'updatearticle', 432, 3, 'cms/updatearticle', 0, 0, 2, '', '', '', 1, 1493343780, NULL),
...
(467, '首页', 'admin', 'index', 'index', 0, 1, 'index/index', 1, 0, 0, '', '', '', 1, 1494485612, 1497071676),
...
(472, '添加或修改', 'admin', 'order', 'addreturn', 471, 3, 'order/addreturn', 1, 0, 1, '添加退货', '', '', 1, 1496215892, 1496216067),
...
(480, '添加商品规格', 'admin', 'goods', 'addgoodsspec', 479, 3, 'goods/addgoodsspec', 0, 1, 1, '', '', '', 1, 1496368895, NULL),
(481, '修改商品规格', 'admin', 'goods', 'updategoodsspec', 479, 3, 'goods/updategoodsspec', 0, 1, 0, '', '', '', 1, 1496386955, NULL),
(482, '商品类型', 'admin', 'goods', 'attributelist', 149, 2, 'goods/attributelist', 1, 0, 7, '', '', '', 1, 1496392434, 1496392497),
(484, '添加商品类型', 'admin', 'goods', 'addattributeservice', 482, 3, 'goods/addattributeservice', 0, 1, 0, '', '', '', 1, 1496395497, 1496457873),
(485, '修改商品类型', 'admin', 'goods', 'updategoodsattribute', 482, 3, 'goods/updategoodsattribute', 0, 1, 0, '', '', '', 1, 1496396084, NULL),
(486, '地区管理', 'admin', 'config', 'areamanagement', 529, 3, 'config/areamanagement', 0, 0, 50, '', '', '', 1, 1496452390, NULL),
(487, '模板编辑', 'admin', 'express', 'expresstemplate', 189, 3, 'express/expresstemplate', 0, 1, 0, '', '', '', 1, 1496459993, NULL),
...
(495, '邮件设置', 'admin', 'config', 'messageconfig', 439, 3, 'config/messageconfig', 0, 1, 0, '', '', '', 1, 1496731597, NULL),
(496, '短信设置', 'admin', 'config', 'messageconfig', 439, 3, 'config/messageconfig', 0, 1, 0, '', '', '', 1, 1496731636, NULL),
(497, '会员积分明细', 'admin', 'member', 'pointdetail', 145, 3, 'member/pointdetail', 0, 1, 0, '', '', '', 1, 1496739472, NULL),
(498, '会员余额明细', 'admin', 'member', 'accountdetail', 145, 3, 'member/accountdetail', 0, 1, 0, '', '', '', 1, 1496744512, NULL),
...
(506, '模板管理', 'admin', 'config', 'notifytemplate', 439, 3, 'config/notifytemplate', 0, 1, 0, '', '', '', 1, 1496886539, 1496974268),
...
(515, '欢迎页', 'admin', 'index', 'index', 467, 2, 'index/index', 1, 0, 0, '欢迎页', '', '', 1, 1496979062, NULL),
(517, '商品回收站', 'admin', 'goods', 'recycle', 149, 2, 'goods/recyclelist', 1, 0, 11, '', '', '', 1, 1497445996, 1497445996),
(518, '回收站列表', 'admin', 'goods', 'recyclelist', 517, 3, 'goods/recyclelist', 0, 1, 0, '', '', '', 1, 1497445996, 1497445996),
...
(521, '添加自提点', 'admin', 'shop', 'addpickuppoint', 520, 3, 'shop/addpickuppoint', 0, 1, 0, '', '', '', 1, 1498135759, 1498135759),
(522, '修改自提点', 'admin', 'shop', 'updatepickuppoint', 520, 3, 'shop/updatepickuppoint', 0, 1, 0, '', '', '', 1, 1498135759, 1498135759),
...
(525, '运费模板列表', 'admin', 'express', 'freighttemplatelist', 189, 3, 'express/freighttemplatelist', 0, 0, 0, '', '', '', 1, 1498733102, 1498733102),
(526, '编辑运费模板', 'admin', 'express', 'freighttemplateedit', 189, 3, 'express/freighttemplateedit', 0, 0, 2, '', '', '', 1, 1498733102, 1498733102),
...
-- Table `1.1210`.sys_notice_template does not contain any data (it is empty)
...
(12, '物流公司', '{物流公司}', 'express_company', 'order_deliver', 0),
(13, '快递编号', '{快递编号}', 'express_no', 'order_deliver', 0);
...
-- Table `1.1210`.sys_user_log does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_devolution
--

-- Table `1.1210`.sys_version_devolution does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_patch
--

-- Table `1.1210`.sys_version_patch does not contain any data (it is empty)
...
(1, 'Niushop开源商城', 'public/static/images/adv_position/logo.png', '开源商城', '', '0300259', 2, '山西省太原市', 'public/static/images/adv_position/qrcode.png', 'http://www.niushop.com.cn/', '1518079521@qq.com', '400-886-7993', '1518079521', 'y159753', 1, '', '对不起，牛酷商城维护中，大家敬请期待...', 1, 4, 1477452112, 1498896658, 0);

-- 
-- Dumping data for table sys_weixin_auth
--

-- Table `1.1210`.sys_weixin_auth does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_default_replay
--

-- Table `1.1210`.sys_weixin_default_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_fans
--

-- Table `1.1210`.sys_weixin_fans does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_follow_replay
--

-- Table `1.1210`.sys_weixin_follow_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_functions_button
--

-- Table `1.1210`.sys_weixin_functions_button does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_instance_msg
--

-- Table `1.1210`.sys_weixin_instance_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_key_replay
--

-- Table `1.1210`.sys_weixin_key_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media
--

-- Table `1.1210`.sys_weixin_media does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media_item
--

-- Table `1.1210`.sys_weixin_media_item does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_menu
--

-- Table `1.1210`.sys_weixin_menu does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_msg_template
--

-- Table `1.1210`.sys_weixin_msg_template does not contain any data (it is empty)
...
-- Table `1.1210`.sys_weixin_user_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_user_msg_replay
--

-- Table `1.1210`.sys_weixin_user_msg_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wexin_onekeysubscribe
--

-- Table `1.1210`.sys_wexin_onekeysubscribe does not contain any data (it is empty)
