...
interface IConfig
{
     ...
     *
     * @param 店铺id $shop_id            
     * @param 模板名称 $template_name            
     * @param 模板数据 $template_data            
     */
    function addCustomTemplate($shop_id, $template_name, $template_data);
     ...
     */
    function updateCustomTemplate($id, $shop_id, $template_name, $template_data);
