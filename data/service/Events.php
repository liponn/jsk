...
class Events implements IEvents{
    ...
    public function ordersClose(){
        ...
        try{
            ...
            $time = strtotime(date("Y-m-d H:i:s", time()-$close_time*60));//订单自动关闭
            $condition = array(
                'order_status' => 0,
    ...
    public function ordersComplete(){
        ...
        try{
            ...
            $time = strtotime(date("Y-m-d H:i:s", time()-3600*24*$complete_time));//订单自动完成
    ...
    public function autoDeilvery(){
        ...
        try{
            ...
            $time = strtotime(date("Y-m-d H:i:s", time()-3600*24*$delivery_time));//订单自动完成
