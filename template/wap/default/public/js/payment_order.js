	...
	if($(".mask-layer-control[data-flag='distribution'] li").length){
		$(".mask-layer-control[data-flag='distribution'] li").each(function(i){
			if(i==0){
				...
				case 1:
					//商家配送
					if(parseInt($(".mask-layer-control[data-flag='distribution']").attr("data-is-logistics"))) $(".item-options[data-flag='express_company']").slideDown(300);//物流公司显示
					else  $(".item-options[data-flag='express_company']").slideUp(300);//物流公司显示
