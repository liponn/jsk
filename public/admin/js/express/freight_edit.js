...
$(function(){
	...
	$(".drop-down").click(function (){
		var self = $(this);
//		var left = $("#select-region .title").offset().left;//最左端
//		var right = $(".js-cancle").offset().left;//最右端
//		var curr_left = curr.offset().left;
//		var curr_top = curr.offset().top;
//		var width = curr.outerWidth();
//		console.log("left:"+curr_left);
//		console.log("top:"+curr_top);
//		console.log("width:"+width);
//		console.log((curr_left-400-width));
//		if((curr_left + 230) > right){
			//左侧显示
//			curr.next().css({
//				left:curr_left,
//				top : curr_top
...
//		$("[data-open]").removeClass("open");
//		$("[data-open-children]").hide();
		if(!is_visible){
